...
import paddle
from paddlenlp.transformers.roberta.modeling import RobertaForMaskedLM, RobertaConfig, MaskedLMOutput
...
class RobertHead(RobertaForMaskedLM):
    ...
    def __init__(self, **config):
        ...
        attention_probs_dropout_prob = config['decoder_args'].pop('attention_probs_dropout_prob')
        ...
        robert_config = RobertaConfig(vocab_size=vocab_size,
    ...
    def forward(
        ...
        **kwargs
        ...
        try:
            ...
            print(f'token_type_ids: {token_type_ids}, position_ids: {position_ids}, attention_mask: {attention_mask}, inputs_embeds: {inputs_embeds}, output_attentions: {output_attentions}, output_hidden_states: {output_hidden_states}, return_dict: {return_dict}')
            raise e
