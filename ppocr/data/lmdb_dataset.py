...
class LMDBDealer(Dataset):
    def __init__(self, data_dir, logger):
        """deal with the lmdb outside the system of pipeline

        Args:
            data_dir (str|PathLike): include mdb file and lock
...
class LMDBDataSet(Dataset):
    def __init__(self, config, mode, logger, seed=None):
        ...
        Args:
            config (str|PathLike): the path of config.yml of distrillation
                 or training. 
            mode (str): can be one of [Train, Eval]
            logger (logger): can be any logger
